 ...
 */
package uts_raihan.adinata_2101092064_16november22;
...
public class PenjualanExample {
     public static void main( String[] args ){
         ...
         penjualan1.setFaktur("41RT522");
         penjualan1.setPelanggan("Raihan");
         penjualan1.setKode("2101092064");
         penjualan1.setHarga(200000);
         penjualan1.setJumlah(4);
